...
@echo on
cmake -S . -B build/test/ -G "Ninja" -DCMAKE_CXX_COMPILER=%CLANGCL% -DCMAKE_C_COMPILER=%CLANGCL% -DCMAKE_C_FLAGS_RELEASE="%CFLAGSCLANGCL%" -DCMAKE_CXX_FLAGS_RELEASE="%CFLAGSCLANGCL%" -DCMAKE_BUILD_TYPE=Release 
ninja -C build/test/
cmake -S . -B build/debug/test/ -G "Ninja" -DCMAKE_CXX_COMPILER=%CLANGCL% -DCMAKE_C_COMPILER=%CLANGCL% -DCMAKE_C_FLAGS_DEBUG="%CFLAGSCLANGCLD%" -DCMAKE_CXX_FLAGS_DEBUG="%CFLAGSCLANGCLD%" -DCMAKE_BUILD_TYPE=DEBUG 
